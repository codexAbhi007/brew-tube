...
export const UserPageBanner = ({ user }: UserPageBannerProps) => {
  ...
  return (
    <div className="relative group">
      ...
      <div
        className={cn(
          "w-full max-h-[200px] h-[15vh] md:h-[25vh] bg-gradient-to-r from-gray-100 to-gray-200 dark:bg-gradient-to-r dark:from-neutral-800 dark:to-neutral-900 rounded-xl",
          user.bannerUrl
            ? "bg-cover bg-center"
      ...
      >
        {user.clerkId == userId && (
          <Button
            ...
            className="absolute top-4 right-4 rounded-full bg-black/50 hover:bg-black/75 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          >
